...
int main() {
    ...
    animateText("\t\t     !!WELCOME ", 50, true);
    animateText(" TO ", 50, true);
    animateText(" THE MYTHICAL ", 50, true);
    animateText(" WORLD!! \n\n", 50, true);
    animateText("\t\t\t   !!SLAY ", 50, true);
    animateText(" TO ", 50, true);
    animateText(" STAY!! ", 50, true);
	Sleep(2000);
	system("cls");
	cout<<"\n\n\n\n\n\n\n\n\n";
	cout<<"\t\t\tLoading";
	...
	animateText("\t\t\tEnter the Quest Number (1-4)\n\n", 50, true);
    animateText("1. Yoshimitsu's Challenge\n", 50, true);
    animateText("2. Dragon Quest\n", 50, true);
    animateText("3. Mind Game Quest\n", 50, true);
    animateText("4. Monster Quest\n", 50, true);
        cin >> role;
        ...
        case 2:
        {
            ...
            animateText("\t\t\t!!Welcome to the Enhanced River Quest!!\n", 50, true);
        ...
        case 3:
        {
            ...
            animateText( "\nHello ", 50, true);
            animateText( playerName, 50, true);
            animateText( "!! Your quest begins... !!\n", 50, true);
            Sleep(2000);
            system("cls");
            animateText("You are stuck in a 3 Rooms challenge with different creatures\n", 50, true);
            animateText("The only way out is solving the riddles\n", 50, true);
            Sleep(2000);
            system("cls");
            cout<<"\n\n\n\n\n\n\n\n\n";
	        cout<<"\t\t\tLoading";
	...
	system("cls");
        ...
        animateText("1. Continue to the next quest\n", 50, true);
        
        animateText("2. Exit the game\n", 50, true);
        
        animateText("3. Take a rest\n", 50, true);
    ...
    cout<<"\n\n\n\n";
	animateText("\t\t     !!EXITING THE GAME....BYE BYE!!\n ", 50, true);
	...
	system("cls");
        ...
        case 3:
            ...
            cout<<"\n\n\n\n";
			animateText("\t\t     !!YOU TAKE A REST. \n", 50, true);
            Sleep(2000);
            system("cls");
            cout<<"\n\n\n\n";
            animateText(" RESTING....\n ", 50, true);
            cout<<"\n\n\n\n";
            animateText("You feel refreshed and ready for the next quest!\n", 50, true);
